...
public class GPSTrackerBackup extends Activity implements LocationListener {
    ...
    public GPSTrackerBackup (Context context) {
...
//                return;
            ...
            locationManager.removeUpdates (GPSTrackerBackup.this);
        }
    }
